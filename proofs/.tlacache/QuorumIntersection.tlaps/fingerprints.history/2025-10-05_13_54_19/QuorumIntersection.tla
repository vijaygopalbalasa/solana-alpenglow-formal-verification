...
PROOF BY SumStakeUnion, SumStakeBound, SumStakeNat
...
LEMMA FastIntersection ==
    ...
    PROVE Q1 \cap Q2 # {}
PROOF BY SumStakeDisjoint, SumStakeBound, ThresholdBounds, SumStakeNat, DoubleLowerBound
...
PROOF BY IntersectionStakeLowerBound, DoubleLowerBound, SumStakeNat
